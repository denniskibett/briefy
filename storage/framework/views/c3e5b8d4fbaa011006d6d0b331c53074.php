<?php $__env->startSection('content'); ?>
    ...
    <div x-data="{ pageName: 'Suppliers' }">
        <?php echo $__env->make('partials.breadcrumb', ['pageName' => '<?php echo e($supplier->name); ?>'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <!-- Breadcrumb End -->
    ...
    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
            Suppliers (<?php echo e($totalSuppliers); ?>)
          </h3>
        </div>
      ...
      <div class="w-full overflow-x-auto">
        <table class="min-w-full">
          ...
          <tr>
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                        <a href="<?php echo e(route('suppliers.show', $supplier->id)); ?>">
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90"><?php echo e($supplier->name ?? 'N/A'); ?></p>
                        </a>
                      <span class="text-gray-500 text-theme-xs dark:text-gray-400"><?php echo e($supplier->contact_name); ?></span>
                    </div>
                  </div>
                </div>
              </td>
              <td class="py-3">
                <div>
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($supplier->address); ?></p>
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400"><?php echo e($supplier->location); ?></span>
                </div>
              </td>
              <td class="py-3">
                <div>
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400"> <?php echo e($supplier->phone); ?></p>
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400"><?php echo e($supplier->email); ?></span>
                </div>
              </td>
              <td class="py-3">
                <div class="flex items-center">
              ...
              <td class="py-3">
                <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($supplier->category_id); ?></p>
                </div>
              </td>
              ...
              <td class="py-3">
                    ...
                    <form action="<?php echo e(route('suppliers.destroy', $supplier->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure?');">
                        <?php echo csrf_field(); ?>
            ...
            <tr>
                <td colspan="5" class="text-center">No  assigned to this supplier.</td>
            </tr>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\briefy\resources\views/suppliers/index.blade.php ENDPATH**/ ?>