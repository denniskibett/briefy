            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div class="space-y-6">
                ...
                >
                  ...
                  <div
                    class="space-y-6 border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6"
                  >
                    <!-- Elements -->
                    <div>
                      <label
                          ...
                          <div class="relative z-20 inline-block w-full">
                            <div class="relative flex flex-col items-center">
                              <div @click="open" class="w-full">
                                <div
                                  class="mb-2 flex h-11 rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 shadow-theme-xs outline-none transition focus:border-brand-300 focus:shadow-focus-ring dark:border-gray-700 dark:bg-gray-900 dark:focus:border-brand-300"
                                >
                                  <div class="flex flex-auto flex-wrap gap-2">
                                    ...
                                    >
                                      <input
                                        ...
                                        class="h-full w-full appearance-none border-0 bg-transparent p-1 pr-2 text-sm outline-none placeholder:text-gray-800 focus:border-0 focus:outline-none focus:ring-0 dark:placeholder:text-white/90"
                                        :value="selectedValues()"
                                      />
                                    </div>
                                  </div>
                                  <div
                                    class="flex w-7 items-center py-1 pl-1 pr-1"
                                  >
                                    <button
                                      type="button"
                                      @click="open"
                                      class="h-5 w-5 cursor-pointer text-gray-700 outline-none focus:outline-none dark:text-gray-400"
                              ...
                              <div class="w-full px-4">
                                <div
                                  ...
                                  class="max-h-select absolute left-0 top-full z-40 w-full overflow-y-auto rounded-lg bg-white shadow dark:bg-gray-900"
                                  @click.outside="close"
                                >
              ...
              <div class="space-y-6">
                      ...
                      <div class="relative">
                        <div class="absolute right-0">
                          <select
                            x-model="selectedCountry"
                            @change="phoneNumber = countryCodes[selectedCountry]"
                            class="appearance-none rounded-r-lg border-0 border-l border-gray-200 bg-transparent bg-none py-3 pl-3.5 pr-8 leading-tight text-gray-700 focus:border-brand-300 focus:outline-none focus:ring focus:ring-brand-500/10 dark:border-gray-800 dark:text-gray-400"
                          >
                            <option
                              value="US"
                              class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"
                        ...
                        >
                          <div class="relative">
                            ...
                            <div
                              ...
                              class="f mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] hover:border-brand-500 dark:hover:border-brand-500"
                            >
                ...
                >
                  ...
                  >
                    <form
                      class="dropzone rounded-xl border-dashed border-gray-300 bg-gray-50 p-7 hover:border-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:hover:border-brand-500 lg:p-10"
                      id="demo-upload"
                      action="/upload"
                    >
                      <div class="dz-message !m-0">
                        ...
                        <span
                          class="text-theme-sm font-medium text-brand-500 underline"
                        >
                          Browse File
                        </span>
                      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\briefy\resources\views/form-elements.blade.php ENDPATH**/ ?>