<?php $__env->startSection('content'); ?>
  <main>
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: '<?php echo e($client->name); ?>' }">
        ...
        <div class="mb-6 rounded-2xl border border-gray-200 p-5 dark:border-gray-800 lg:p-6">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-800 dark:text-white/90">
                        <?php echo e($client->status == 0 ? 'Inactive' : 'Active'); ?>
        ...
        <table class="min-w-full">
            <thead>
                <tr class="border-gray-100 border-y dark:border-gray-800">
                    ...
                    <th class="py-3">
                        <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Start Date</p>
                    </th>
                    <th class="py-3">
                    ...
                    <th class="py-3">
                        <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Quote</p>
                    </th>
                    <th class="py-3">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                <?php $__empty_1 = true; $__currentLoopData = $client->brief; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brief): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="block font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                            <a href="<?php echo e(route('client.brief.show', ['client' => $client->id, 'brief_id' => $brief->id])); ?>" class="hover:underline"><?php echo e($brief->name); ?></a>
                                        </span>
                                        <span class="block text-gray-500 text-theme-xs dark:text-gray-400">
                                            <?php echo e($brief->category->name ?? 'N/A'); ?>
                        ...
                        <td class="py-3">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e(\Carbon\Carbon::parse($brief->start_date)->format('d/m/Y')); ?></p>
                        </td>
                        <td class="py-3">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e(\Carbon\Carbon::parse($brief->end_date)->format('d/m/Y')); ?></p>
                        </td>
                        <td class="py-3">
                        ...
                        <td class="py-3">
                            <a href="<?php echo e(route('briefs.brief', ['brief_id' => $brief->id])); ?>" class="text-blue-600 hover:underline">
                        ...
                        <td class="py-3">
                            <a href="<?php echo e(route('briefs.edit', $brief->id)); ?>" class="text-green-600 hover:underline">
                            ...
                            <form action="<?php echo e(route('briefs.destroy', $brief->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure?');">
                                <?php echo csrf_field(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="8" class="py-4 px-6 text-center">No briefs available for this client.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('partials.profile.profile-info-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('partials.profile.profile-address-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>



<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\briefy\resources\views/clients/client.blade.php ENDPATH**/ ?>