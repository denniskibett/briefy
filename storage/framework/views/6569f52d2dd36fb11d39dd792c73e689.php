...
<main>
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: 'BOM Suppliers' }">
        <?php echo $__env->make('partials.breadcrumb', ['pageName' => 'BOM Suppliers'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- Breadcrumb End -->
      ...
      <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
            Specific Suppliers for <?php echo e($bom_name); ?>
        ...
        <table class="min-w-full">
          <thead>
            <tr class="border-gray-100 border-y dark:border-gray-800">
              ...
              <th class="py-3">
                <div class="flex items-center">
                  <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">MOQ Cost</p>
                </div>
              </th>
              <th class="py-3">
          ...
          <tr>
              <td class="py-3">
                <div class="flex items-center">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                        <a href="#">
                            <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90"><?php echo e($supplier->name); ?></p>
              ...
              <td class="py-3">
                <div>
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($supplier->email); ?></p>
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400"><?php echo e($supplier->phone); ?></span>
                </div>
              </td>
              <td class="py-3">
                <div>
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400"></p>
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400">KES </span>
                </div>
              </td>
            ...
            <tr>
                <td colspan="5" class="text-center">No suppliers found for <?php echo e($bom_name); ?>. Add a supplier now</td>
            </tr>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\briefy\resources\views/bom_suppliers/index.blade.php ENDPATH**/ ?>