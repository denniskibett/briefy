...
<main>
        ...
        <?php echo $__env->make('partials.breadcrumb', ['pageName' => 'Add New Briefs'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- Breadcrumb End -->
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
            ...
            <form action="<?php echo e(route('briefs.store')); ?>" method="POST" class="border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6">
                <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="category_id" id="category_id" required 
                                ...
                                <?php $__currentLoopData = $industryCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                        ...
                        <div>
                            ...
                            <select name="client_id" id="client_id" required 
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($client->id); ?>" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\briefy\resources\views/briefs/create.blade.php ENDPATH**/ ?>