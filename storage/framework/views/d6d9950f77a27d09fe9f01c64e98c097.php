<?php $__env->startSection('content'); ?>
    <main>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
            ...
            <form action="<?php echo e(route('clients.update', $client->id)); ?>" method="POST" class="border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_name" id="contact_name" value="<?php echo e(old('contact_name', $client->contact_name)); ?>" required 
                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-none focus:ring focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="address" id="address" value="<?php echo e(old('address', $client->address)); ?>" required 
                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-none focus:ring focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" id="location" value="<?php echo e(old('location', $client->location)); ?>" required 
                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-none focus:ring focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="tax_pin" id="tax_pin" value="<?php echo e(old('tax_pin', $client->tax_pin)); ?>" required 
                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus border-brand-300 focus:outline-none focus:ring focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div x-data="{
                            ...
                            phoneNumber: '<?php echo e(old('phone', $client->phone)); ?>'
                        }">
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: <?php echo e(old('category_id', $client->category_id) ? 'true' : 'false'); ?> }" class="relative z-20 bg-transparent">
                                <select 
                                    name="category_id" 
                                    id="category_id" 
                                    required
                                ...
                                >
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $client->category_id) == $category->id ? 'selected' : ''); ?> class="text-gray-700 dark:bg-gray-900 dark:text-gray-400"><?php echo e($category->name); ?></option>
                        ...
                        <!-- Status -->
                        <div x-data="{ status: <?php echo e(old('status', $client->status) ? 'true' : 'false'); ?> }">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\briefy\resources\views/clients/edit.blade.php ENDPATH**/ ?>