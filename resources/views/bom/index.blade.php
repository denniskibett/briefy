        ...
        <div class="container mx-auto">
            ...
            <div class="{{ $tableConfig['container'] }}">
                <div class="{{ $tableConfig['headerWrapper'] }}">
                    <div>
                        <h3 class="{{ $tableConfig['headerTitle'] }}">BOM List ({{ $totalBOMs }})</h3>
                    </div>
                            ...
                            <tr class="{{ $tableConfig['theadRow'] }}">
                                <th class="{{ $tableConfig['th'] }}">
                                    <div class="flex items-center">
                                        <p class="{{ $tableConfig['thText'] }}">Material</p>
                                    </div>
                                </th>
                                <th class="{{ $tableConfig['th'] }}">
                                    <div class="flex items-center">
                                        <p class="{{ $tableConfig['thText'] }}">Unit Cost</p>
                                    </div>
                                </th>
                                <th class="{{ $tableConfig['th'] }}">
                                    <div class="flex items-center">
                                        <p class="{{ $tableConfig['thText'] }}">MOQ</p>
                                    </div>
                                </th>
                                <th class="{{ $tableConfig['th'] }}">
                                    <div class="flex items-center">
                                        <p class="{{ $tableConfig['thText'] }}">MOQ Cost</p>
                                    </div>
                                </th>
                                <th class="{{ $tableConfig['th'] }}">
                                    <div class="flex items-center">
                            ...
                            @forelse ($boms as $bom)
                                <tr>
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <span class="block font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                                        <a href="{{ route('bom_suppliers.index', ['bom' => $bom->id]) }}" class="hover:underline">{{ $bom->name }}</a>
                                                    </span>
                                                    <span class="block text-gray-500 text-theme-xs dark:text-gray-400">
                                                        {{ $bom->category ? $bom->category->name : 'N/A' }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                KES {{ number_format($bom->unit_cost, 2) }}
                                            </p>
                                        </div>
                                    </td>
                                    <!-- Projects Column -->
                                    ...
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                KES {{ number_format($bom->quantity * $bom->unit_cost, 2) }}
                                            </p>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-3">
                                        <a href="{{ route('bom.edit', $bom->id) }}" class="text-green-600 hover:underline">
                                        ...
                                        <form action="{{ route('bom.destroy', $bom->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
