...
@section('content')
   ...
   <!-- Breadcrumb Start -->
   <div x-data="{ pageName: '{{ $supplier->name }}' }">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $supplier->tax_pin }}</p>
                </div>
    ...
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
      <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="{{ route('bom_suppliers.create', $supplier->id) }}">
            <button class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                Add BoM
            </button>
          </a>
      ...
      <div class="w-full overflow-x-auto">
        <table class="min-w-full">
          ...
          @if($supplier->bomSuppliers->isNotEmpty())
          @foreach ($supplier->bomSuppliers as $bomSupplier)
          <tr>
              <td class="py-3">
                <div class="flex items-center">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                        <a href="{{ route('suppliers.bom', ['supplier' => $bomSupplier->supplier_id]) }}">
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $bomSupplier->bom->name ?? 'N/A' }}</p>
                        </a>
              ...
              <td class="py-3">
                <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400">KES {{ number_format($bomSupplier->unit_cost, 2) }}/piece</p>
                </div>
              </td>
              <td class="py-3">
                <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400"> {{ $bomSupplier->quantity }}</p>
                </div>
              </td>
              <td class="py-3">
                <div class="flex items-center">
              ...
              <td class="py-3">
                <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400">KES {{ number_format($bomSupplier->unit_cost*$bomSupplier->quantity, 2) }}</p>
                </div>
              </td>
