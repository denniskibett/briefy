<aside
  ...
  class="fixed left-0 top-0 z-50 h-screen w-[290px] flex flex-col border-r border-gray-200 bg-white px-5 dark:border-gray-800 dark:bg-black transition-all duration-300 ease-in-out lg:static lg:translate-x-0"
>
  <!-- SIDEBAR HEADER -->
  <div
  ...
  >
    <!-- Sidebar Menu -->
    <nav x-data="{ selected: $persist('Dashboard'), page: '' }">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <a
            href="#"
            @click.prevent="selected = (selected === 'Dashboard' ? '' : 'Dashboard'); console.log(selected)"
        ...
        <li>
          ...
          >
            <svg
              :class="(selected === 'Calendar') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              ...
              class="menu-item group"
              :class="(selected === 'Charts') || (page === 'lineChart' || page === ' bar Chart' || page === 'pieChart') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
