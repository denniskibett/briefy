    ...
    <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6">
            ...
            <div x-data="{ pageName: 'Profile'}">
                @include('partials.breadcrumb', ['pageName' => 'Prfile'])
            </div>
            <!-- Breadcrumb End -->
                    ...
                    <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                        <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                            ...
                            <div class="order-3 xl:order-2">
                                <h4 class="mb-2 text-center text-lg font-semibold text-gray-800 dark:text-white/90 xl:text-left">Emirhan Boruch</h4>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-800 dark:text-white/90">emirhanboruch55@gmail.com</p>
                                </div>
