...
<main>
    ...
    <div x-data="{ pageName: 'BOM Suppliers' }">
        @include('partials.breadcrumb', ['pageName' => 'BOM Suppliers'])
    </div>
    <!-- Breadcrumb End -->
      ...
      <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
            Specific Suppliers for {{ $bom_name }}
          </h3>
        </div>
      ...
      <div class="w-full overflow-x-auto">
        <table class="min-w-full">
          ...
          <tr>
              <td class="py-3">
                <div class="flex items-center">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                        <a href="#">
                            <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $supplier->name }}</p>
              ...
              <td class="py-3">
                <div>
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $supplier->email }}</p>
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400">{{ $supplier->phone }}</span>
                </div>
              </td>
              <td class="py-3">
                <div>
            ...
            @empty
            <tr>
                <td colspan="5" class="text-center">No suppliers found for {{ $bom_name }}. Add a supplier now</td>
            </tr>
            @endforelse
