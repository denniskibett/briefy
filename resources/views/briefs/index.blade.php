...
@section('content')
  ...
  <main>
    ...
    <div x-data="{ pageName: 'Briefs' }">
        @include('partials.breadcrumb', ['pageName' => 'Briefs'])
    </div>
    <!-- Breadcrumb End -->
      ...
      <div class="w-full overflow-x-auto">
        <table class="min-w-full">
          ...
          <tr>
              <td class="py-3">
                <div class="flex items-center">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                        <a href="{{ route('briefs.brief', ['brief_id' => $brief->id]) }}">
                            <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $brief->name }}</p>
                            <span class="text-gray-500 text-theme-xs dark:text-gray-400">{{ $brief->client->name ?? 'N/A' }}</span>
                        </a>
                    </div>
                  </div>
                </div>
              ...
              <td class="py-3">
                <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400">KES {{ number_format($brief->production_cost, 2) }}</p>
                </div>
              </td>
              <td class="py-3">
                <div class="flex items-center">
              ...
              <td class="py-3">
                <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400">KES {{ number_format($brief->budget - $brief->production_cost, 2) }}</p>
                </div>
              </td>
              <td class="py-3">
                <div class="flex items-center">
              ...
              <td>
              <div class="flex items-center">
                  <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ \Carbon\Carbon::parse($brief->deadline)->format('D, d/m/y') }}</p>
                </div>
              </td>
